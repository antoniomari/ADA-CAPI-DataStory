...
<embed src="{{ site.url }}{{ site.baseurl }}/_includes/logistic_regression_coefficients.pdf" width="100%" height="800px" type='application/pdf'></embed>
...
<embed src="{{ site.url }}{{ site.baseurl }}/_includes/shapley_easy_game_2.pdf" width="1000px" height="100%" type='application/pdf'></embed>
...
<embed src="{{ site.url }}{{ site.baseurl }}/_includes/shapley_harder_game_2.pdf" width="1000px" height="100%" type='application/pdf'></embed>
